...
export const useOptimisticAuth = (options: UseOptimisticAuthOptions = {}) => {
    const { initialState = {}, optimisticTimeout = 10000, // 10 seconds
    confidenceThreshold = 'medium' } = options;
    ...
    const createOptimisticUpdate = useCallback((user: User, userRole: UserType, source: OptimisticUpdate['source']): OptimisticUpdate => {
