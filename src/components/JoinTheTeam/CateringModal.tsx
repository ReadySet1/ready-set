  ...
  const handleApplyClick = (e: React.MouseEvent) => {
    ...
    setTimeout(() => {
      ...
      if (window.location.pathname === '/apply') {
        ...
        router.push('/apply?role=Driver for Catering Deliveries');
            ...
            <CardContent className="p-6 text-center">
              ...
              <Link href="/apply?role=Driver for Catering Deliveries">
                <Button 
                  ...
                  size="lg"
                  className="bg-white text-amber-300 hover:bg-gray-50 shadow-xl hover:shadow-2xl transition-all duration-300 px-8 py-3 rounded-xl font-semibold"
                >
