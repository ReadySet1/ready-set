...
const page = [
    {
      ...
      image: getCloudinaryUrl("testimonials/author-01")
    },
    {
      category: 'CLIENTS',
      name: 'Dennis Ngai',
      ...
      image: getCloudinaryUrl("testimonials/author-02")
    },
    {
      category: 'CLIENTS',
      ...
      image: getCloudinaryUrl("testimonials/author-03")
    },
    {
      category: 'CLIENTS',
      name: 'Jami Yazdani ',
      ...
      image: getCloudinaryUrl("testimonials/author-09")
    },
    {
      category: 'CLIENTS',
      name: 'Crystal Rapada',
      ...
      image: getCloudinaryUrl("testimonials/author-04"),
    },
    {
      category: 'CLIENTS',
      ...
      image: getCloudinaryUrl("testimonials/author-08"),
    },
    {
      category: 'CLIENTS',
      name: 'Brian Escobar',
      ...
      image: getCloudinaryUrl("testimonials/author-10"),
    },
    {
      category: 'DRIVERS',
      name: 'Chris L.',
      ...
      image: getCloudinaryUrl("testimonials/author-06")
    },
    {
      category: 'DRIVERS',
      ...
      image: getCloudinaryUrl("testimonials/author-05")
    },
    {
      category: 'VENDORS',
      name: 'John Smith',
      ...
      text: 'Working with Ready Set has been life-changing for me. The support from the team is unmatched—they always ensure I have all the information I need to complete my deliveries efficiently. I\'ve also gained access to great opportunities and flexible hours, which allow me to balance work with my personal life. I feel respected and valued every step of the way, and that motivates me to give my best every day. Ready Set is not just a job; it feels like a community that genuinely cares about its drivers.',
      image: getCloudinaryUrl("testimonials/author-07")
    },
    // {
    //   category: 'VENDORS',
    //   name: 'Sarah Johnson',
