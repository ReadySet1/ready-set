 ...
 */
export function ErrorTrigger({ errorType = "REACT_ERROR", error, children, }: {
    ...
    return (<div className="rounded-lg border border-gray-200 p-4">
      <div className="mb-4 flex items-center justify-between">
        ...
        <button onClick={() => setShouldError(true)} className="rounded bg-red-600 px-3 py-1 text-sm text-white hover:bg-red-700">
          Trigger Error
        </button>
      </div>
