...
export class SecureAPIRoute {
     ...
     */
    static create<T extends any[], R>(handler: (request: NextRequest & {
        validatedData?: any;
        sanitizedData?: any;
    }, ...args: T) => Promise<NextResponse>, options: {
        ...
        const { rateLimit = 'API', validation, csrf, requireAuth = false, allowedRoles = [], customSecurity } = options;
     ...
     */
    static async auth<T extends any[], R>(handler: (request: NextRequest & {
        validatedData?: any;
    }, ...args: T) => Promise<NextResponse>, options: {
        validation?: Parameters<typeof import('./validation').withValidation>[0];
        rateLimit?: 'AUTH';
     ...
     */
    static admin<T extends any[], R>(handler: (request: NextRequest & {
        validatedData?: any;
        authContext?: any;
    }, ...args: T) => Promise<NextResponse>, options: {
        validation?: Parameters<typeof import('./validation').withValidation>[0];
     ...
     */
    static async upload<T extends any[], R>(handler: (request: NextRequest & {
        validatedData?: any;
        sanitizedData?: any;
    }, ...args: T) => Promise<NextResponse>, options: {
        validation?: Parameters<typeof import('./validation').withValidation>[0];
     ...
     */
    static sensitive<T extends any[], R>(handler: (request: NextRequest & {
        validatedData?: any;
        authContext?: any;
    }, ...args: T) => Promise<NextResponse>, options: {
        validation?: Parameters<typeof import('./validation').withValidation>[0];
...
export const SecurityUtils = {
     ...
     */
    updateConfig: (config: Parameters<typeof securityConfigManager.updateConfig>[0]) => securityConfigManager.updateConfig(config),
    /**
     ...
     * Log security event
     */
    logEvent: async (type: Parameters<typeof import('./security-logging').securityLogger.log>[0], severity: Parameters<typeof import('./security-logging').securityLogger.log>[1], message: string, request: NextRequest, details?: Record<string, any>, userId?: string) => {
...
export type { SecurityConfig, SecurityMonitoringConfig } from './security-config';
export type { SecurityEventType, SecurityEventSeverity, SecurityEvent } from './security-logging';
export type { RateLimitConfig, RateLimitConfigs } from './rate-limiting';
export type { ValidationConfig, ValidationPatterns, CommonSchemas, ApiSchemas } from './validation';
export type { CSRFConfig, CSRFConfigs } from './csrf-protection';
export type { SecurityHeadersConfig, SecurityHeaderConfigs } from './security-headers';
export type { IPAccessControlConfig, GeolocationRule } from './ip-management';
