...
export function useJobApplicationUpload({ bucketName = "user-assets", defaultUploadedFiles = [], maxFileCount = 1, maxFileSize = 5 * 1024 * 1024, // 5MB by default
allowedFileTypes = [], entityType, userId, entityId: initialEntityId, category, }: UseJobApplicationUploadOptions = {}) {
