    ...
    <div className="bg-white py-16">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div>
            <FAQSectionComponent
              title="Mileage Pricing"
              items={mileagePricing}
            />
            <FAQSectionComponent
              title="Order & Delivery Details"
              items={orderDeliveryDetails}
            />
          </div>
          <div>
            <FAQSectionComponent
              title="Order Capacity & Pricing"
              items={orderCapacityPricing}
            />
            <FAQSectionComponent
              title="Delivery Errors & Corrections"
              items={deliveryErrors}
            />
            <FAQSectionComponent
