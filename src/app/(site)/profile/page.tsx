...
const userTypeConfig = {
  ...
  admin: { 
    className: "bg-gradient-to-r from-purple-50 to-purple-100 text-purple-800 border border-purple-200", 
    icon: <Shield className="h-3 w-3 mr-1" />,
    color: "purple"
  },
  super_admin: { 
    className: "bg-gradient-to-r from-rose-50 to-rose-100 text-rose-800 border border-rose-200", 
    icon: <Shield className="h-3 w-3 mr-1" />,
    color: "rose"
  },
  helpdesk: { 
    className: "bg-gradient-to-r from-indigo-50 to-indigo-100 text-indigo-800 border border-indigo-200", 
    icon: <User className="h-3 w-3 mr-1" />,
    color: "indigo"
  },
};
...
const getUserTypeConfig = (type: string) => {
  return userTypeConfig[type as keyof typeof userTypeConfig] || { 
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <div className="flex items-center gap-4 mb-3">
                ...
                <Badge className={`${userTypeInfo.className} flex items-center gap-1 px-3 py-1.5 font-semibold text-sm rounded-full shadow-sm`}>
                  {userTypeInfo.icon}
              ...
              {isEditing ? (
                <>
                  <Button
                    ...
                    variant="outline"
                    className="px-6 py-2.5 rounded-xl border-slate-200 hover:bg-slate-50 transition-all duration-200 flex items-center gap-2"
                  >
                    <X className="h-4 w-4" />
                    Cancel
                  </Button>
                  <Button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
                  >
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 bg-slate-50 rounded-xl text-slate-800 flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="contact_number" className="text-sm font-medium text-slate-700">Phone Number</Label>
                    {isEditing ? (
                      <Input
                        id="contact_number"
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      ...
                      <div className="p-3 bg-slate-50 rounded-xl text-slate-800 flex items-center gap-2">
                        ...
                        {profile.website ? (
                          <a href={profile.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 transition-colors">
                            {profile.website}
                          </a>
                        ) : (
                          'Not provided'
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2 space-y-2">
                    <Label htmlFor="street1" className="text-sm font-medium text-slate-700">Street Address</Label>
                    {isEditing ? (
                      <Input
                        id="street1"
                  ...
                  <div className="md:col-span-2 space-y-2">
                    <Label htmlFor="street2" className="text-sm font-medium text-slate-700">Street Address 2</Label>
                    {isEditing ? (
                      <Input
                        id="street2"
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-8">
                ...
                {/* File Upload Section */}
                <div className="space-y-6">
                  <h3 className="text-lg font-medium text-slate-800">Upload New Documents</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="border-2 border-dashed border-slate-200 rounded-xl p-4 hover:border-slate-300 transition-colors">
                          <FileUploader
                            onUpload={async (files) => {
                              try {
                                await field.hook.onUpload(files as FileWithPath[]);
                                handleUploadSuccess();
                              } catch (error) {
                            ...
                            accept={field.name === 'driver_photo' || field.name === 'vehicle_photo' 
                              ? { "image/*": [] } 
                              : { "image/*": [], "application/pdf": [] }
                            }
                            maxSize={3 * 1024 * 1024}
                            maxFileCount={field.name === 'general_files' ? 5 : 1}
                            category={field.name}
                            entityType="user"
                            entityId={user?.id || ''}
                          >
                            <div className="text-center py-4">
                              ...
                              <p className="text-xs text-slate-400 mt-1">
                                {field.name === 'driver_photo' || field.name === 'vehicle_photo' 
                                  ? 'Images only, max 3MB' 
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div>
                  <div className="text-sm font-medium text-slate-500 mb-2">Account Type</div>
                  <Badge className={`${userTypeInfo.className} flex items-center gap-1 px-3 py-2 font-semibold text-sm rounded-full shadow-sm w-fit`}>
                    {userTypeInfo.icon}
                    {profile.type?.replace('_', ' ') || 'User'}
                  </Badge>
                </div>
                <div>
                  ...
                  <Badge className={`${statusInfo.className} flex items-center gap-1 px-3 py-2 font-semibold text-sm rounded-full shadow-sm w-fit`}>
                    {profile.status || 'pending'}
                  </Badge>
                </div>
                {profile.type === 'driver' && (
                  <div className="mt-4 p-3 bg-amber-50 rounded-xl border border-amber-200">
                    <p className="text-xs text-amber-700">
                      <strong>Driver Requirements:</strong> Please upload all required documents to activate your account.
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="space-y-4">
                  {profile.created_at && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-slate-800">Account Created</div>
                  ...
                  {files.length > 0 && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-sm font-medium text-slate-800">Documents Uploaded</div>
                        <div className="text-xs text-slate-500">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                <Button
                  variant="outline"
                  className="w-full justify-start gap-2 hover:bg-slate-50 rounded-xl"
                  onClick={() => router.push('/dashboard')}
                >
