...
import { FormType, DeliveryFormData, BakeryFormData, FlowerFormData, FoodFormData, SpecialtyFormData, } from "../types";
...
export const FormManager = () => {
    ...
    return {
        openForm,
        closeForm,
        DialogForm: (<DialogFormContainer isOpen={isDialogOpen} onClose={closeForm} formType={activeFormType} onSubmit={handleSubmit}/>),
    };
};
