    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      <div className="container mx-auto py-6 px-4 space-y-6 max-w-7xl">
        ...
        <div className="flex items-center gap-4">
          <Link href="/admin/calculator" className="text-slate-500 hover:text-slate-700 transition-colors">
        ...
        <ClientConfigurationManager currentConfigId={currentConfigId} onConfigurationChange={(config) => {
