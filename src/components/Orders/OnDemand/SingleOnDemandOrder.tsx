...
const OrderSkeleton: React.FC = () => (<div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-blue-50">
...
const SingleOnDemandOrder: React.FC<SingleOnDemandOrderProps> = ({ onDeleteSuccess, showHeader = true, }) => {
    ...
    const orderNumber = decodeURIComponent((pathname ?? "").split("/").pop() || "");
    ...
    if (!order) {
        return (<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-cyan-50 via-white to-blue-50">
        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.3 }} className="mx-4 max-w-md rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-xl">
          ...
          <Button variant="default" onClick={() => window.history.back()} className="rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 px-6 py-2 text-white shadow-lg transition-all duration-200 hover:from-cyan-600 hover:to-blue-600 hover:shadow-xl">
            Go Back
          </Button>
        </motion.div>
      </div>);
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-blue-50">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="container mx-auto px-6 py-8">
        {/* Modern Header */}
        <div className="mb-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <div className="mb-2 flex items-center gap-4">
                ...
                {onDemandOrder && (<div className={`flex items-center gap-1 rounded-full bg-slate-100 px-3 py-1.5 text-sm font-medium text-slate-700`}>
        ...
        }} driverInfo={driverInfo} updateDriverStatus={updateDriverStatus} canAssignDriver={userRoles.isAdmin ||
            userRoles.isSuperAdmin ||
            userRoles.isHelpdesk} canUpdateDriverStatus={userRoles.isAdmin || userRoles.isSuperAdmin} onAssignDriver={handleOpenDriverDialog}/>
                <Separator />
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {order.user?.email && (<div>
                      ...
                      <div className="flex items-center gap-2 text-slate-800">
                        ...
                        <a href={`mailto:${order.user.email}`} className="transition-colors hover:text-cyan-600">
                          {order.user.email}
                        </a>
                      </div>
                    </div>)}
                  {order.user?.contactNumber && (<div>
                      ...
                      <div className="flex items-center gap-2 text-slate-800">
                        ...
                        <a href={`tel:${order.user.contactNumber}`} className="transition-colors hover:text-cyan-600">
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              ...
              <div className="space-y-4 p-6">
                {onDemandOrder && (<div className="flex items-center justify-between">
                ...
                {order.orderTotal && (<div className="flex items-center justify-between border-t pt-3">
