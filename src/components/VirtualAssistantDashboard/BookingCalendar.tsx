        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <Calendar mode="single" selected={date} onSelect={handleDateSelect} className="rounded-md border" disabled={(date) => date < new Date()}/>
            </div>
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handleBooking} className="w-full" disabled={!selectedTime}>
                Book Appointment
              </Button>

              {selectedTime && (<div className="mt-4 p-4 bg-blue-50 rounded-md">
                  <p className="text-sm">
