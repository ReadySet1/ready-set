 ...
 */
export async function updateCaterValleyOrderStatus(orderNumber: string, status: OrderStatus): Promise<CaterValleyUpdateResult> {
...
export async function updateCaterValleyOrderStatusLegacy(orderNumber: string, status: OrderStatus): Promise<CaterValleyApiResponse> {
