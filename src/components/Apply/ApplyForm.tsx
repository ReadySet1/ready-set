...
const SearchParamsHandler = ({ onRoleChange, }: {
...
const JobApplicationForm = () => {
    ...
    const { register, handleSubmit, watch, reset, setValue, formState: { errors, isSubmitting: formIsSubmitting, isDirty, isValid }, trigger, } = useForm<FormData>({
    ...
    return (<div className="w-full">
      ...
      {fromSignup && !isSubmitted && (<div className="mb-6 rounded border-l-4 border-yellow-400 bg-yellow-50 p-4">
          <div className="flex">
      ...
      <div className="relative mb-8">
        <div className="mb-6 flex items-center justify-between">
          <button onClick={goToPrevStep} className={`flex items-center text-gray-500 transition-colors hover:text-gray-700 ${currentStep === 1 ? "invisible" : ""}`} disabled={currentStep === 1}>
            <ArrowLeft className="mr-2 h-4 w-4"/>
            <span className="text-sm font-medium">Back</span>
          </button>

          <div className="flex items-center space-x-2">
            {FORM_STEPS.map((step) => (<button key={step.id} className={`h-3 w-3 rounded-full transition-colors duration-200 ${step.id === currentStep
                ? "bg-yellow-500"
                : step.id < currentStep
                    ? "bg-yellow-300"
                    : "bg-gray-300"}`} aria-label={`Go to step ${step.id}`} onClick={() => {
          ...
          <button onClick={goToNextStep} className={`flex items-center text-gray-500 transition-colors hover:text-gray-700 ${currentStep === 4 ? "invisible" : ""}`}>
        ...
        <div className="h-1 w-full rounded-full bg-gray-100">
          <div className="h-full rounded-full bg-yellow-400 shadow-sm transition-all duration-300" style={{
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
        ...
        {currentStep === 1 && (<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700">
                Select Position *
              </label>
              <div className="relative">
                <select className={`block w-full rounded-md border ${errors.role ? "border-red-500" : "border-gray-300"} appearance-none bg-white px-3 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("role", {
            required: "Please select a position",
        })}>
                  <option value="">Choose a position</option>
                  {positions.map((pos, idx) => (<option key={idx} value={pos.title}>
                      {pos.title}
                    </option>))}
                </select>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <input type="text" className={`block w-full rounded-md border ${errors.firstName ? "border-red-500" : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("firstName", {
            ...
            minLength: {
              ...
              <div>
                ...
                <input type="text" className={`block w-full rounded-md border ${errors.lastName ? "border-red-500" : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("lastName", {
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <input type="email" className={`block w-full rounded-md border ${errors.email ? "border-red-500" : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("email", {
            ...
            pattern: {
              ...
              <div>
                ...
                <input type="tel" className={`block w-full rounded-md border ${errors.phone ? "border-red-500" : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("phone", {
            ...
            <div className="space-y-4">
              ...
              <input type="text" placeholder="Street Address" className={`block w-full rounded-md border ${errors.address?.street ? "border-red-500" : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("address.street", {
            required: "Street address is required",
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <input type="text" placeholder="City" className={`block w-full rounded-md border ${errors.address?.city
                ? "border-red-500"
                : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("address.city", {
            required: "City is required",
        })}/>
                  {renderError(errors.address?.city)}
                </div>
                <div>
                  <input type="text" placeholder="State" className={`block w-full rounded-md border ${errors.address?.state
                ? "border-red-500"
                : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("address.state", {
            required: "State is required",
              ...
              <input type="text" placeholder="ZIP Code" className={`block w-full rounded-md border ${errors.address?.zip ? "border-red-500" : "border-gray-200"} px-4 py-2.5 text-gray-700 focus:border-yellow-400 focus:outline-none focus:ring-1 focus:ring-yellow-400`} {...register("address.zip", {
        ...
        {currentStep === 2 && (<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
            {!isDriverRole ? (<>
                <div>
                  <label className="block text-sm font-medium text-gray-700">
                    Education *
                  </label>
                  <textarea className={`mt-1 block w-full rounded-md border ${errors.education ? "border-red-500" : "border-gray-300"} px-3 py-2 focus:border-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400`} rows={3} placeholder="List your educational background..." {...register("education", {
                ...
                <div>
                  ...
                  <textarea className={`mt-1 block w-full rounded-md border ${errors.workExperience
                    ? "border-red-500"
                    : "border-gray-300"} px-3 py-2 focus:border-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400`} rows={4} placeholder="Describe your relevant work experience..." {...register("workExperience", {
                ...
                <div className="space-y-4">
                  ...
                  {[0, 1, 2].map((index) => (<div key={index}>
                      <input type="text" className={`block w-full rounded-md border ${errors.skills?.[index]
                        ? "border-red-500"
                        : "border-gray-300"} px-3 py-2 focus:border-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400`} placeholder={`Skill ${index + 1} (e.g., ${index === 0
                        ? "Customer Service"
                        : index === 1
                            ? "Time Management"
                            : "Problem Solving"})`} {...register(`skills.${index}`, {
                    ...
                    minLength: {
                      ...
                      {errors.skills?.[index] && (<p className="mt-1 text-sm text-red-600">
                ...
                <div>
                  ...
                  <textarea className={`mt-1 block w-full rounded-md border ${errors.coverLetter ? "border-red-500" : "border-gray-300"} px-3 py-2 focus:border-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-400`} rows={4} placeholder="Tell us why you're interested in this position..." {...register("coverLetter")}/>
        ...
        {/* Step 3: Documents */}
        {currentStep === 3 && (<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
            {isDriverRole ? (<div className="grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-2">
                ...
                <div>
                  ...
                  <FileUpload name="driversLicense" label="Upload Driver's License" startUpload={licenseUpload.onUpload as any} file={(licenseUpload.uploadedFiles[0] as HookUploadedFile) ||
                    null} deleteFile={licenseUpload.deleteFile} accept={generateAcceptString(IMAGE_PDF_TYPES)} isUploading={licenseUpload.isUploading} progresses={licenseUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="insurance" label="Upload Insurance" startUpload={insuranceUpload.onUpload as any} file={(insuranceUpload.uploadedFiles[0] as HookUploadedFile) ||
                    null} deleteFile={insuranceUpload.deleteFile} accept={generateAcceptString(IMAGE_PDF_TYPES)} isUploading={insuranceUpload.isUploading} progresses={insuranceUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="vehicleRegistration" label="Upload Registration" startUpload={registrationUpload.onUpload as any} file={(registrationUpload
                    .uploadedFiles[0] as HookUploadedFile) || null} deleteFile={registrationUpload.deleteFile} accept={generateAcceptString(IMAGE_PDF_TYPES)} isUploading={registrationUpload.isUploading} progresses={registrationUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="foodHandler" label="Upload Card (Optional)" startUpload={foodHandlerUpload.onUpload as any} file={(foodHandlerUpload
                    .uploadedFiles[0] as HookUploadedFile) || null} deleteFile={foodHandlerUpload.deleteFile} accept={generateAcceptString(IMAGE_PDF_TYPES)} isUploading={foodHandlerUpload.isUploading} progresses={foodHandlerUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="driverPhoto" label="Upload Photo" startUpload={driverPhotoUpload.onUpload as any} file={(driverPhotoUpload
                    .uploadedFiles[0] as HookUploadedFile) || null} deleteFile={driverPhotoUpload.deleteFile} accept={generateAcceptString([".jpg", ".jpeg", ".png"])} isUploading={driverPhotoUpload.isUploading} progresses={driverPhotoUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="carPhoto" label="Upload Photo" startUpload={carPhotoUpload.onUpload as any} file={(carPhotoUpload.uploadedFiles[0] as HookUploadedFile) ||
                    null} deleteFile={carPhotoUpload.deleteFile} accept={generateAcceptString([".jpg", ".jpeg", ".png"])} isUploading={carPhotoUpload.isUploading} progresses={carPhotoUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="equipmentPhoto" label="Upload Photo (Optional)" startUpload={equipmentPhotoUpload.onUpload as any} file={(equipmentPhotoUpload
                    .uploadedFiles[0] as HookUploadedFile) || null} deleteFile={equipmentPhotoUpload.deleteFile} accept={generateAcceptString([".jpg", ".jpeg", ".png"])} isUploading={equipmentPhotoUpload.isUploading} progresses={equipmentPhotoUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="hipaa" label="Upload Certificate (Optional)" startUpload={hipaaUpload.onUpload as any} file={(hipaaUpload.uploadedFiles[0] as HookUploadedFile) || null} deleteFile={hipaaUpload.deleteFile} accept={generateAcceptString(IMAGE_PDF_TYPES)} isUploading={hipaaUpload.isUploading} progresses={hipaaUpload.progresses}/>
                </div>
                ...
                <div>
                  ...
                  <FileUpload name="resume" label="Upload Resume (.pdf, .doc, .docx)" startUpload={resumeUpload.onUpload as any} file={(resumeUpload.uploadedFiles[0] as HookUploadedFile) ||
                    null} deleteFile={resumeUpload.deleteFile} accept={generateAcceptString(RESUME_TYPES)} isUploading={resumeUpload.isUploading} progresses={resumeUpload.progresses}/>
                </div>
              </div>)}
          </motion.div>)}

        {/* Step 4: Review & Submit */}
        {currentStep === 4 && (<motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
            ...
            <div className="space-y-4 divide-y divide-gray-200">
              ...
              {!isDriverRole && (<>
                  ...
                  <div className="pt-2">
                    ...
                    <ul className="mt-1 list-inside list-disc">
                      {watch("skills")
                    .filter(Boolean)
                    .map((skill, index) => (<li key={index} className="text-sm">
                            {skill}
                          </li>))}
                    </ul>
                  </div>
              ...
              {isDriverRole && (<div className="pt-2">
                  <h4 className="font-medium text-gray-700">
                    Required Documents
                  </h4>
                  <div className="mt-1 grid grid-cols-1 gap-2 md:grid-cols-2">
        ...
        <div className="flex justify-between border-t border-gray-200 pt-6">
          {currentStep > 1 ? (<button type="button" onClick={(e) => goToPrevStep(e)} className="flex items-center rounded-md border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-yellow-400">
              <ArrowLeft className="mr-2 h-4 w-4"/>
              Previous
            </button>) : (<div></div> // Empty div to maintain flex spacing
        )}

          {currentStep < FORM_STEPS.length ? (<button type="button" onClick={(e) => goToNextStep(e)} className="flex items-center rounded-md border border-transparent bg-yellow-400 px-5 py-2.5 text-sm font-medium text-white hover:bg-yellow-500 focus:outline-none focus:ring-1 focus:ring-yellow-400">
              Next
              <ArrowRight className="ml-2 h-4 w-4"/>
            </button>) : (<button type="button" onClick={handleSubmit(onSubmit)} disabled={isSubmitting} className="rounded-md border border-transparent bg-yellow-400 px-5 py-2.5 text-sm font-medium text-white hover:bg-yellow-500 focus:outline-none focus:ring-1 focus:ring-yellow-400 disabled:opacity-50">
