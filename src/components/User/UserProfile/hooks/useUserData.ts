...
const getDisplayNameByUserType = (userType: string | null | undefined, name: string | null | undefined, contactName: string | null | undefined): string => {
...
export const useUserData = (userId: string, refreshTrigger: number, setRefreshTrigger: React.Dispatch<React.SetStateAction<number>>): UseUserDataReturn => {
    // State management
    ...
    const fetchUser = useCallback(async () => {
        ...
        try {
            ...
            const formData: UserFormValues = {
                ...
                cateringBrokerage: Array.isArray(data.cateringBrokerage) ? data.cateringBrokerage : stringToValueArray(data.cateringBrokerage),
                ...
                head_count: data.headCount ?? null,
