...
vi.mock("@/components/FeaturesTab", () => ({
  default: () => <div data-testid="mock-features-tab">FeaturesTab</div>,
}));
vi.mock("@/components/FunFact", () => ({
  default: () => <div data-testid="mock-fun-fact">FunFact</div>,
}));
vi.mock("@/components/Integration", () => ({
  default: () => <div data-testid="mock-integration">Integration</div>,
}));
...
vi.mock("@/components/Testimonial", () => ({
  default: () => <div data-testid="mock-testimonial">Testimonial</div>,
}));
vi.mock("@/components/Contact", () => ({
  default: () => <div data-testid="mock-contact">Contact</div>,
}));
