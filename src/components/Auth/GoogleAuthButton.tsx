...
const GoogleAuthButton = ({ className = "", userType, mode = "signup", }: GoogleAuthButtonProps) => {
    ...
    return (<button type="button" disabled={isLoading} onClick={handleGoogleSignIn} className={`flex w-full items-center justify-center gap-2.5 rounded-lg border border-gray-4 p-3.5 text-dark duration-200 ease-in hover:border-gray-5 hover:bg-gray disabled:cursor-not-allowed disabled:opacity-70 dark:border-dark-3 dark:text-white dark:hover:bg-dark-3 ${className}`}>
