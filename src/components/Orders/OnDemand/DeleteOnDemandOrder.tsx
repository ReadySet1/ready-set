...
import { deleteOnDemandOrder, DeleteOrderResult } from "@/app/(backend)/admin/on-demand-orders/_actions/on-demand-orders";
import { UserRole } from "./types";

interface DeleteOnDemandOrderProps {
  orderId: string;
  orderNumber: string;
  userRoles: UserRole;
  onDeleted?: () => void;
...
export const DeleteOnDemandOrder: React.FC<DeleteOnDemandOrderProps> = ({
  orderId,
  orderNumber,
  userRoles,
  onDeleted,
...
export default DeleteOnDemandOrder;
