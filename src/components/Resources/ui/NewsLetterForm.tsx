...
export default function NewsletterForm() {
    ...
    return (<div className="flex flex-col md:flex-row items-center justify-center w-full bg-white p-4 sm:p-6 md:p-8 gap-8">
      ...
      <div className="mb-4 smb-6">
        ...
        required: "First name is required",
                  ...
                  {errors.firstName && (<span className="text-sm text-red-500">
        ...
        required: "Last name is required",
                  ...
                  {errors.lastName && (<span className="text-sm text-red-500">
        ...
        required: "Industry is required",
                  ...
                  {errors.industry && (<span className="text-sm text-red-500">
              ...
              <div className="mt-4">
                <label className="flex items-center">
                  <input type="checkbox" {...register("newsletterConsent")} className="form-checkbox h-4 w-4 text-blue-600 transition duration-150 ease-in-out"/>
              ...
              <button type="submit" disabled={isLoading} className={`mt-6 w-full rounded-full px-4 py-2 transition-colors ${isLoading
            ? "cursor-not-allowed bg-gray-400"
            : "bg-gray-800 hover:bg-gray-700"} flex items-center justify-center text-white`}>
                {isLoading ? (<>
          ...
          <div className="flex w-full flex-col items-center justify-center border-l border-gray-200 pt-6 md:w-1/3 md:pt-0">
            <img src="/images/logo/logo-white.png" alt="Penguin Logo" className="mb-4 h-10 object-contain"/>
            ...
            <div className="hidden md:flex items-center justify-center gap-4">
              <Link aria-label="Facebook" href="https://www.facebook.com/" target="_blank" className="text-gray-400 hover:text-yellow-500">
            ...
            <Link aria-label="tiktok" href="https://www.tiktok.com/@readyset.co" target="_blank" className="mx-2 px-3 text-gray-400 hover:text-yellow">
              <svg width="22" height="22" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
            ...
            <Link aria-label="instagram" href="https://www.instagram.com/readyset.co/" target="_blank" className="mx-2 px-3 text-gray-400 hover:text-yellow">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
            ...
            <Link aria-label="LinkedIn" href="http://linkedin.com/company/ready-set-group-llc/" target="_blank" className="mx-2 px-3 text-gray-400 hover:text-yellow">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20.3763 0H1.62375C0.726562 0 0 0.726562 0 1.62375V20.3763C0 21.2734 0.726562 22 1.62375 22H20.3763C21.2734 22 22 21.2734 22 20.3763V1.62375C22 0.726562 21.2734 0 20.3763 0ZM6.81094 18.7688H3.47969V8.25469H6.81094V18.7688ZM5.14531 6.81094C4.07656 6.81094 3.20625 5.94063 3.20625 4.87188C3.20625 3.80313 4.07656 2.93281 5.14531 2.93281C6.21406 2.93281 7.08438 3.80313 7.08438 4.87188C7.08438 5.94063 6.21406 6.81094 5.14531 6.81094ZM18.7688 18.7688H15.4375V13.6531C15.4375 12.4469 15.4375 10.8906 13.7719 10.8906C12.1063 10.8906 11.8328 12.2063 11.8328 13.5219V18.7688H8.50156V8.25469H11.6688V9.69844H11.7781C12.2063 8.86719 13.3125 8.00781 14.9781 8.00781C18.3594 8.00781 18.7688 10.2094 18.7688 13.0156V18.7688Z" fill="currentColor"/>
                </svg>
              </svg>
            </Link>
          </div>
