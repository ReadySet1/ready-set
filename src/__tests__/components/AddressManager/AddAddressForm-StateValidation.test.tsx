...
describe.skip("AddAddressForm - CA State Validation Fix", () => {
  ...
  it("should maintain all other form data during state normalization", async () => {
    ...
    await user.type(
      screen.getByLabelText(/parking \/ loading information/i),
      "Street parking available",
    );

    // Check checkboxes
    await user.click(screen.getByLabelText(/this is a restaurant/i));
    await user.click(screen.getByLabelText(/make this address shared/i));
