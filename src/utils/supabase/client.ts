        ...
        try {
            supabaseInstance = createBrowserClient(supabaseUrl, supabaseAnonKey, {
                cookies: {
                    ...
                    set: (name: string, value: string, options: CookieOptions) => setStorageCookie(name, value, options),
                    remove: (name: string, options: CookieOptions) => removeStorageCookie(name, options)
                },
                auth: {
                    flowType: 'pkce',
...
export const retryAuthOperation = async <T>(operation: () => Promise<T>, options: RetryOptions = {}): Promise<T> => {
