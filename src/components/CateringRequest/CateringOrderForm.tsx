    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-4">
        ...
        minLength: {
          ...
          {errors.eventName && (<p className="mt-1 text-sm text-red-500">
        ...
        validate: {
          ...
          {errors.eventDate && (<p className="mt-1 text-sm text-red-500">
        ...
        required: "Event time is required",
          ...
          {errors.eventTime && (<p className="mt-1 text-sm text-red-500">
        ...
        <div>
          ...
          <Textarea id="specialInstructions" {...register("specialInstructions")} placeholder="Any special requirements or preferences?" rows={4}/>
        </div>
      </div>

      <div className="space-y-4">
        <Label>Event Location</Label>
        <AddressManager onAddressSelected={handleAddressSelect} onAddressesLoaded={handleAddressesLoaded} defaultFilter="all"/>
        {errors.addressId && (<p className="mt-1 text-sm text-red-500">
