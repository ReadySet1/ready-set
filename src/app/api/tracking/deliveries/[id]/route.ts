...
export async function PUT(
  ...
  try {
    ...
    const validStatuses: DriverStatus[] = [DriverStatus.ASSIGNED, DriverStatus.EN_ROUTE_TO_VENDOR, DriverStatus.ARRIVED_AT_VENDOR, DriverStatus.PICKED_UP, DriverStatus.EN_ROUTE_TO_CLIENT, DriverStatus.ARRIVED_TO_CLIENT, DriverStatus.COMPLETED];
